local const = {
    ...
    TEXT = {
        ...
        TUTO = {"Touche E = ramasser","avant de pouvoir utiliser les armes il faut les ramasser", "Touche A = Epée", "touche B = Arc", "Touche ESC = quitter", "Touche F1 = debug", "Appuyer sur une touche pour commencer"},
